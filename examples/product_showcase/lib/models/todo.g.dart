...
mixin _$TodoUpdateDust {
  ...
  TodoUpdate copyWith({
    ...
    return TodoUpdate(
      ...
      isCompleted: identical(isCompleted, _undefined) ? _dustSelf.isCompleted : isCompleted as bool?,
    );
  }
...
Todo _$TodoFromJson(Map<String, Object?> json) {
  ...
  final isCompletedValue = _dustJsonAs<bool>(json['isCompleted'], 'isCompleted', 'bool');
