//! Reading arguments, type arguments and method names off a call node.

use super::*;

/// Builds a parsed query call surface from extracted parts.
pub(super) fn query_call_surface(
...
pub(super) fn query_function_node(
    node: Node<'_>,
    source: &SourceText,
) -> Option<ParsedQueryFunction> {
...
pub(super) fn query_function_name(name: &str) -> Option<ParsedQueryFunction> {
    match name {
...
pub(super) fn type_arguments_source(type_args: Node<'_>, source: &SourceText) -> Option<String> {
...
pub(super) fn argument_sources(arguments: Node<'_>, source: &SourceText) -> Vec<String> {
...
pub(super) fn argument_source(argument: Node<'_>, source: &SourceText) -> Option<String> {
...
pub(super) fn selector_type_arguments_source(
    selector: Node<'_>,
    source: &SourceText,
) -> Option<String> {
...
pub(super) fn selector_argument_sources(
    selector: Node<'_>,
    source: &SourceText,
) -> Option<Vec<String>> {
...
pub(super) fn selector_property_name(selector: Node<'_>, source: &SourceText) -> Option<String> {
...
pub(super) fn fetch_method_for_query_call(
    query_call: Node<'_>,
    source: &SourceText,
) -> Option<String> {
...
pub(super) fn is_fetch_method(method: &str) -> bool {
    matches!(
        method,
        "fetchOptional"
            | "fetchOne"
...
pub(super) fn same_node(lhs: Node<'_>, rhs: Node<'_>) -> bool {
    lhs.kind() == rhs.kind()
...
pub(super) fn parse_optional_type_arg(
    source: &str,
    start: usize,
...
pub(super) fn parse_list_argument_count(source: &str) -> (bool, usize) {
...
pub(super) fn skip_ws(source: &str, mut offset: usize) -> usize {
