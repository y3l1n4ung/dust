...
pub(crate) fn render_test_file(library: &LibraryIr, specs: &[ClientSpec<'_>]) -> Option<String> {
    ...
    out.push_str("// ignore_for_file: unused_element, unused_import, deprecated_member_use, deprecated_member_use_from_same_package, use_function_type_syntax_for_parameters, unnecessary_const, avoid_init_to_null, invalid_override_different_default_values_named, prefer_expression_function_bodies, annotate_overrides, invalid_annotation_target, unnecessary_question_mark\n");
