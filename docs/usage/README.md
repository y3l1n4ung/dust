...
| Apply common routing patterns | [Routing recipes](./routing-recipes.md) | `dust_flutter` |
| Check routing API details | [Routing reference](./routing-reference.md) | `dust_flutter` |
