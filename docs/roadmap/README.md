...
| Parser architecture | P1 | Canonical `DartFileIr`, parser-owned lowering, resolver enrichment, plugin migration | [parser-architecture-refactor.md](parser-architecture-refactor.md) |
